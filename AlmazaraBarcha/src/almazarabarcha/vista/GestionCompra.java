...
public class GestionCompra extends JFrame {
    ...
    private List<Compra> comprasNoPagadas;
     ...
     */
    public GestionCompra(Proveedor p, JPanel jpanel, JPanel jpanel1, Usuario u) {
        initComponents();
        ...
        try {
            comprasNoPagadas = DaoCompra.getComprasNoPagadas(p);
            comprasPagadas = DaoCompra.getComprasPagadas(p);
        ...
        for (Compra c : comprasNoPagadas) {
            filaNoPagados[0] = c.getIdCompra();
            filaNoPagados[1] = c.getFecha();
            filaNoPagados[2] = c.getKgOliva();
            filaNoPagados[3] = c.getPrecioKg();
            filaNoPagados[4] = c.getTotalCompra();
        ...
        for (Compra c : comprasPagadas) {
            filaPagados[0] = c.getIdCompra();
            filaPagados[1] = c.getFecha();
            filaPagados[2] = c.getKgOliva();
            filaPagados[3] = c.getPrecioKg();
            filaPagados[4] = c.getTotalCompra();
    ...
    private void initComponents() {
        ...
        tabla_no_pagados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Kg Oliva", "Precio Kg", "Total compra"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(label_titulo, javax.swing.GroupLayout.DEFAULT_SIZE, 981, Short.MAX_VALUE)
    ...
    private void tabla_no_pagadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_no_pagadosMouseClicked
        FinalizarCompra fc = new FinalizarCompra(jpanel,u,comprasNoPagadas.get(tabla_no_pagados.getSelectedRow()));
        jpanel1.removeAll();
